...
namespace Gerenciador_de_Produtos.Data.Migrations
{
    ...
    [Migration("20250617103118_CriacaoRelacionamentosItensERPConfigurador")]
    partial class CriacaoRelacionamentosItensERPConfigurador
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gerenciador_de_Produtos.Models.ItemERPComposto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ItemERPId_Filho")
                        .HasColumnType("int");

                    b.Property<int>("ItemERPId_Pai")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ItemERPId_Filho");

                    b.HasIndex("ItemERPId_Pai");

                    b.ToTable("ItensERPCompostos");
                });
            ...
            modelBuilder.Entity("Gerenciador_de_Produtos.Models.ItemERPVinculado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("ItemERP_GalvanizadoId")
                        .HasColumnType("int");

                    b.Property<int?>("ItemERP_PintadoId")
                        .HasColumnType("int");

                    b.Property<int?>("ItemERP_SemAcabamentoId")
                        .HasColumnType("int");

                    b.Property<int?>("ItemERP_ZincadoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ItemERP_GalvanizadoId");

                    b.HasIndex("ItemERP_PintadoId");

                    b.HasIndex("ItemERP_SemAcabamentoId");

                    b.HasIndex("ItemERP_ZincadoId");

                    b.ToTable("ItensERPVinculados");
                });
            ...
            modelBuilder.Entity("Gerenciador_de_Produtos.Models.VariaveisItemERPComposto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ItemERPCompostoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ItemERPCompostoId");

                    b.HasIndex("ItemERPId");

                    b.ToTable("VariaveisItemERPCompostos");
                });
            ...
            modelBuilder.Entity("Gerenciador_de_Produtos.Models.ItemERPComposto", b =>
                {
                    b.HasOne("Gerenciador_de_Produtos.Models.ItemERP", "ItemERP_Filho")
                        .WithMany()
                        .HasForeignKey("ItemERPId_Filho")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Gerenciador_de_Produtos.Models.ItemERP", "ItemERP_Pai")
                        .WithMany("ItensCompostos")
                        .HasForeignKey("ItemERPId_Pai")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ItemERP_Filho");

                    b.Navigation("ItemERP_Pai");
                });
            ...
            modelBuilder.Entity("Gerenciador_de_Produtos.Models.ItemERPVinculado", b =>
                {
                    ...
                    b.HasOne("Gerenciador_de_Produtos.Models.ItemERP", "ItemERP_Galvanizado")
                        .WithMany()
                        .HasForeignKey("ItemERP_GalvanizadoId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Gerenciador_de_Produtos.Models.ItemERP", "ItemERP_Pintado")
                        .WithMany()
                        .HasForeignKey("ItemERP_PintadoId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Gerenciador_de_Produtos.Models.ItemERP", "ItemERP_SemAcabamento")
                        .WithMany()
                        .HasForeignKey("ItemERP_SemAcabamentoId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Gerenciador_de_Produtos.Models.ItemERP", "ItemERP_Zincado")
                        .WithMany()
                        .HasForeignKey("ItemERP_ZincadoId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("ItemERP_Galvanizado");

                    b.Navigation("ItemERP_Pintado");

                    b.Navigation("ItemERP_SemAcabamento");

                    b.Navigation("ItemERP_Zincado");
                });
            ...
            modelBuilder.Entity("Gerenciador_de_Produtos.Models.VariaveisItemERPComposto", b =>
                {
                    b.HasOne("Gerenciador_de_Produtos.Models.ItemERPComposto", "ItemERPComposto")
                        .WithMany("Variaveis")
                        .HasForeignKey("ItemERPCompostoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Gerenciador_de_Produtos.Models.ItemERP", null)
                        .WithMany("VariaveisComposicao")
                        .HasForeignKey("ItemERPId");

                    b.Navigation("ItemERPComposto");
                });
            ...
            modelBuilder.Entity("Gerenciador_de_Produtos.Models.ItemERP", b =>
                {
                    ...
                    b.Navigation("ItensCompostos");

                    b.Navigation("ItensRelacionados");

                    b.Navigation("ItensVinculados");
                    ...
                    b.Navigation("VariaveisComposicao");
                });
