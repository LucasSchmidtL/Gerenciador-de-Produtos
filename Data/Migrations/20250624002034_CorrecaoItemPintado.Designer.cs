...
namespace Gerenciador_de_Produtos.Data.Migrations
{
    ...
    [Migration("20250624002034_CorrecaoItemPintado")]
    partial class CorrecaoItemPintado
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItemERPComposto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ItemERPVinculado", b =>
                {
                    ...
                    b.HasIndex("VinculadoId");

                    b.ToTable("ItensVinculados");
                });
            ...
            modelBuilder.Entity("Gerenciador_de_Produtos.Models.VariaveisItemERPComposto", b =>
                {
                    b.HasOne("ItemERPComposto", "ItemERPComposto")
                        .WithMany("Variaveis")
            ...
            modelBuilder.Entity("ItemERPComposto", b =>
                {
                    ...
                    b.HasOne("Gerenciador_de_Produtos.Models.ItemERP", "ItemFilho")
                        .WithMany()
                        .HasForeignKey("ItemFilhoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Gerenciador_de_Produtos.Models.ItemERP", "ItemPai")
                        .WithMany()
            ...
            modelBuilder.Entity("ItemERPVinculado", b =>
                {
                    b.HasOne("Gerenciador_de_Produtos.Models.ItemERP", "Descricao")
                        .WithMany()
