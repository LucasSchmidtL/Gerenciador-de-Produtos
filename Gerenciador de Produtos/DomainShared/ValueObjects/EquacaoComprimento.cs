...
//✅ Recebe um texto representando uma fórmula de comprimento (exemplo: "2 * Comp + 5");
...
{
    public class EquacaoComprimento
    {
        public string? Valor { get; }

        public EquacaoComprimento(string? valor)
        {
        ...
        {
            return obj is EquacaoComprimento outro && Valor == outro.Valor;
        }
