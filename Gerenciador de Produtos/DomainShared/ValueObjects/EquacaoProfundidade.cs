...
//✅ Recebe um texto representando uma fórmula de profundidade (exemplo: "2 * Comp + 5");
...
{
    public class EquacaoProfundidade
    {
        public string? Valor { get; }

        public EquacaoProfundidade(string? valor)
        {
        ...
        {
            return obj is EquacaoProfundidade outro && Valor == outro.Valor;
        }
